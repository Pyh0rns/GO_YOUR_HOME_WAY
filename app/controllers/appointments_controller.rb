class AppointmentsController < ApplicationController
  ...
  def create
    ...
    @appointment.property = Property.find(cookies[:property_id].to_i)
    ...
    unless @appointment.property.favorites.exists?(company: @appointment.company)
      Favorite.create!(property: Property.find(cookies[:property_id].to_i), company: @appointment.company )
    end
